...
#ifndef _LEAFBAR_MENU_H
#define _LEAFBAR_MENU_H
...
class LeafbarMenu : public TDEPopupMenu {
  TQ_OBJECT

  public:
    LeafbarMenu(LeafbarPanel *panel);
    LeafbarMenu(LeafbarPanel *panel, KServiceGroup::Ptr group);
    virtual ~LeafbarMenu();
