...
#ifndef _LEAFBAR_TASK_MANAGER_CFG_H
#define _LEAFBAR_TASK_MANAGER_CFG_H
...
class LeafbarTaskManConfig : public LeafbarAppletConfig
{
    TQ_OBJECT

    public:
        LeafbarTaskManConfig(TQWidget *parent, const TQString& cfg);
        ~LeafbarTaskManConfig();
...
#endif // _LEAFBAR_TASK_MANAGER_CFG_H
