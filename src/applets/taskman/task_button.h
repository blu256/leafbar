...
#ifndef _LEAFBAR_TASK_BUTTON_H
#define _LEAFBAR_TASK_BUTTON_H
...
class LeafbarTaskButton : public TQButton
{
  TQ_OBJECT
  ...
  public:
    ...
    LeafbarTaskButton(LeafbarTaskContainer *parent, ButtonType type);
    ~LeafbarTaskButton();
    ...
    LeafbarTaskContainer *container() const;
