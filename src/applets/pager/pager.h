...
#ifndef _LEAFBAR_PAGER_H
#define _LEAFBAR_PAGER_H
...
class LeafbarPager : public LeafbarApplet
{
  TQ_OBJECT

  public:
    LeafbarPager(LeafbarPanel *panel, TDEConfig *cfg);
    ~LeafbarPager();
