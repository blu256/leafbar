...
#ifndef _LEAFBAR_APPLET_H
#define _LEAFBAR_APPLET_H
...
class LeafbarApplet : public TQFrame {
  TQ_OBJECT

  public:
    LeafbarApplet(LeafbarPanel *parent, TDEConfig *cfg, const char *name = 0);
    virtual ~LeafbarApplet();
