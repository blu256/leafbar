...
#ifndef _LEAFBAR_PANEL_H
#define _LEAFBAR_PANEL_H
...
class LeafbarPanel : public TQFrame {
  TQ_OBJECT

  public:
    static LeafbarPanel *instance();
  ...
  friend class LeafbarApp;
};

#endif // _LEAFBAR_PANEL_H
